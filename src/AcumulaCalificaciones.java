public class AcumulaCalificaciones {
    public static void main(String[] args) {
        ...
        double promedioGrupo = (double) sumaCalificaciones / calificaciones.length;

        System.out.println("Cantidad de estudiantes aprobados: " + contadorAprobados);
        System.out.println("Promedio de calificaciones: " + promedioGrupo);
    }
}
